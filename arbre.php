        ...
        <ul class="navigation">
            <li class="sousMenuBascule"><span>&Eacute;v&eacute;nement</span>
                <ul class="sousMenu">
                    ...
                    <li><a href="#" title="Aller à la page Exposition">Exposition</a>
                        <ul>
                    ...
                    <li><a href="#" title="Aller à la page Soirée">Soir&eacute;e</a>
                        <ul>
            ...
            <li class="sousMenuBascule"><span>Forum</span>
                <ul class="sousMenu">
                    <li><a href="forumMan/index.php" title="Aller à la page Discution Générale">Discution g&eacute;n&eacute;rale</a></li>
                    <li><a href="forumMan/organisateur.php" title="Aller à la page Evénement">&Eacute;v&eacute;nement</a></li>
