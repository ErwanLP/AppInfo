...
<section>
    ...
    <article>
        ...
        $req = $bdd->query('SELECT topicforum.* FROM topicforum, souscategorieforum WHERE souscategorieforum.ID = 7 AND topicforum.id_souscategorie = souscategorieforum.ID');
