                    ...
                    <div>
                        ...
                        <div class="info">
                            ...
                            <div class="clear_bloc info">
                                <label class="col_third floatleft" for="email"><span class="required">Email :</span></label>
                        ...
                        <!-- Prénom -->
                        <div class="info">
                            <label for="prénom" class="col_third floatleft">Prénom :</label>
                        ...
                        <!-- Nom -->
                        <div class="info">
                            <label for="Nom" class="col_third floatleft">Nom :</label>
                        ...
                        <!-- Représentant -->
                        <div class="info">
                            <label for="representant" class="col_third floatleft">Représentant de :</label>
                            <input type="text" id="representant" name="representant" class="text" value="Over Games " />
                            </br>
                            <!-- Information sur la société -->
                            <div class=info>
                                <label for=infoSociete class="col_third_floatleft">Pseudo :</label>
                                ...
                                <!-- Adresse -->
                                <div class="info">
                                    <label for="addresse" class="col_third floatleft">Adresse postale :</label>
                                ...
                                <!-- Code Postal -->
                                <div class="info">
                                    <label class="col_third floatleft" for="pcode"><span class="required">Code postal :</span></label>
                                ...
                                <!-- Ville -->
                                <div class="info">
                                    <label for="ville" class="col_third floatleft">Ville :</label>
                                    <input type="text" id="ville" name="ville" class="text" value="Paris" />
                                </div>
                                </br>
                                <!-- Pays -->
                                <div class="info">
                                    <label class="col_third floatleft" for="pays"><span class="required">Pays :</span></label>
                                ...
                                <!-- Site Web -->
                                <div class="info">
                                    <label for="Site Web" class="col_third floatleft">Site Web :</label>
                                ...
                                <!-- Téléphone Mobile -->
                                <div class="info">
                                    <label for="mobilephone" class="col_third floatleft">Mobile :</label>
