...
include("inclure/bdForum");
include("inclure/startForum.php");
//inclure("inclure/menuForum");
?>
<?php
echo 'vous etes encore sur <a href="indexForum.php">l\'index forum</a>';
?>
<h1>notre forum vous apporte du concret</h1>
<?php
//on initialise des variables qui nous serons utile
$totaldesmessages=0;
$categorieDeForum=NULL;
?>
...
while($data = $query->fetch())
{
    ...
    if( $categorieDeForum != $data['cat_id'] )
    {
        //Si c'est une nouvelle catégorie on l'affiche
       
        $categorieDeForum = $data['cat_id'];
?>
        <tr>
        <th></th>
