<?php include("profil.php"); ?>
        ...
        <div class="rollin1">
            ...
            <h2>Invitations envoy&eacute;es</h2>
                                        ...
                                        <ul class="liste_invitation_envoyer">
                                            <li class="invitation_envoyer" id="js-friend-00000002">
                                                <div class="invitation_envoyer">
                                                    ...
                                                    <div class="amis-info">
                                                        <a href="http://guito-le-taureau-bourre-du-sud.doyouevents.com/profil/" onclick="window.open(this.href); return false;"  class="homme">Guito-le-taureau-bourr&eacute;-du-sud</a>
                                                        <p> 
                                                            20 ans         
                                                            <span class="adresse">
                                                                <img class="flag" src="img/flag_fr.png" alt="France" title="France" />
