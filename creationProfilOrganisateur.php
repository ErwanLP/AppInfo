...
<html>
    ...
    <body>
        ...
        <section>
            ...
            <article>
                <div id="titreacticle">
                    <h2><span style="color:#2040c0;"> Cr&eacute;ation Profil Organisateur</span></h2>
                    <p> Actuellement, vous ne disposez pas de profil organisateur. Nous vous invitons à remplir les champs suivants :</p>
                </div>
                <div id="page">
                    ...
                    <form class="contenuCPO" method="post" action="traitementCreationProfilOrganisateur.php">
                        <fieldset class="fieldsetCPO">
                            ...
                            <input type="text" name="nomSocieteO" id="adresseO" size="23" maxlength="20"></br></br>
