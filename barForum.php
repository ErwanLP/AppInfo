...
<section>
    ...
    <article>
        ...
        <div class="creerTopic">
              <a href="ajouterSujet.php?idSouscategorie=8"> Ajouter un sujet</a>
        </div>
        ...
        $req = $bdd->query('(SELECT organisateur.pseudo,topicforum.* FROM topicforum, souscategorieforum,organisateur WHERE souscategorieforum.ID = 8
            AND topicforum.id_souscategorie = souscategorieforum.ID
            AND topicforum.id_organisateur = organisateur.id
            )
            UNION 
            (
            SELECT participant.pseudo,topicforum.* FROM topicforum,souscategorieforum,participant WHERE souscategorieforum.ID=8
             AND topicforum.id_souscategorie = souscategorieforum.ID
        ...
        while ($donnees = $req->fetch()) {
            ...
            $tab_info_bar[$var_tab_info_array][4] = $donnees["pseudo"];
            $var_tab_info_array++;
        }
        ?>
                    ...
                    <table class="affichageTableau">
                        ...
                        <?php for ($a = 0; $a < count($tab_info_bar); $a++) {
                            ...
                            <tr class="affichageSujet">
                                ...
                                <td class="auteur"><?php echo $tab_info_bar[$a][4]; ?></td>
